...
Single-page landing site for **The Decaf Baker** — small-batch bakery. Cookie tacos, cookie buckets, custom smash-heart cakes. Weekend pickup pre-orders + custom cake consults.
...
| 4 | **Signature menu** | 6 product cards: Cookie Taco, Cookie Bucket, Chocolate Chip, Custom Cakes, Chocolate-Covered Everything, Rotating Cast. Each: image, sensory copy, price chip, social-proof tag |
...
2. **Images:** drop real photos into `images/` matching the `src` names (`hero-cookie-taco.jpg`, `menu-cookie-taco.jpg`, `menu-cookie-bucket.jpg`, `menu-choc-chip.jpg`, `menu-heart-cake.jpg`, `menu-dipped.jpg`, `menu-rotating.jpg`, `about-baker.jpg`).
